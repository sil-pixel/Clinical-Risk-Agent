...
6. **Provider constraints:** Which local or operator-controlled isolated VPC LLM and embedding configurations balance reproducibility, cost, latency, language support, and portfolio usability within the no-external-payload boundary?
