...
7. **RAG-01 — Implement approved scientific retrieval architecture** (RAG Engineer): validate source feasibility, ingest the approved corpus, implement embeddings/index/retrieval/reranking, source-cap, evidence-display, and provenance contracts, and execute retrieval-quality/failure evaluations. Depends on AIARCH-01. Done when AC-08, AC-21, and the retrieval portions of AC-22 are demonstrated.
